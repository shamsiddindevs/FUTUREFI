...
const StudentProfiles = () => {
    ...
    return (
        <section className="py-20  text-center ">
            ...
            <div className="w-full max-w-7xl px-5 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {/* University Students Card */}
                <div className="p-8 bg-white rounded-lg shadow-lg border-t-4 border-yellow-500">
                    <div className="text-blue-500 text-5xl mb-4">
                        <img src={onlineClass} className='w-12 mx-auto' alt="onlineClass" />
                    </div>
                ...
                <div className="p-8 bg-white rounded-lg shadow-lg border-t-4 border-yellow-500">
                    <div className="text-orange-500 text-5xl mb-4"><img src={onlineCourse} className='w-12 mx-auto' alt="onlineClass" /></div>
                    <h3 className="text-xl font-semibold">
                ...
                <div className="p-8 bg-white rounded-lg shadow-lg border-t-4 border-yellow-500">
                    <div className="text-green-500 text-5xl mb-4"><img src={career} className='w-12 mx-auto' alt="onlineClass" /></div>
                    <h3 className="text-xl font-semibold">
