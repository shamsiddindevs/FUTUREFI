...
const Classes = () => {
  ...
  return (
    <>
      <section className="mt-[88px] text-center">
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold py-10">
          Lorem ipsum dolor sit amet 
        </h1>
        <p className="max-w-2xl mx-auto text-md lg:text-lg text-gray-700">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. Hic,
          doloribus? Tempora, magni est unde quaerat animi eveniet asperiores
          incidunt temporibus libero error quas, nihil, placeat consequuntur
          accusamus sapiente. Libero, mollitia!
        </p>
