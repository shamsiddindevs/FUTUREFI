  ...
  const courseData = [
    {
      ...
      description: t("classTeach.data.0.description"),
    ...
    },
    {
      ...
      description: t("classTeach.data.1.description"),
    ...
    },
    {
      ...
      description: t("classTeach.data.2.description"),
      borderColor: "border-green-200",
    },
    {
      icon: <AiOutlineBank className="text-blue-600 text-4xl mx-auto mb-4" />,
      title: t("classTeach.data.3.title"),
      description: t("classTeach.data.3.description"),
      borderColor: "border-blue-200",
    },
    {
      icon: (
        <RiAccountCircleLine className="text-orange-600 text-4xl mx-auto mb-4" />
      ),
      title: t("classTeach.data.4.title"),
      description: t("classTeach.data.4.description"),
      borderColor: "border-orange-200",
    },
    {
      icon: <GiTakeMyMoney className="text-green-600 text-4xl mx-auto mb-4" />,
      title: t("classTeach.data.5.title"),

      description: t("classTeach.data.5.description"),
      borderColor: "border-green-200",
    },
  ];
  ...
  return (
    <>
      <section className="pb-20">
        <div
          className=" px-5 text-center min-h-screen flex justify-center items-center flex-col gap-5 "
          style={{
            backgroundImage: `linear-gradient(rgba(133, 255, 184, 0.89), rgba(0, 0, 0, 0.87) ), url(${clas})`,
            ...
            <form
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder={t(
                    "classContact.fields.expectations.placeholder"
                  )}
                  className="w-full p-4 rounded-lg border border-gray-300"></textarea>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  placeholder={t(
                    "classContact.fields.additionalInfo.placeholder"
                  )}
                  className="w-full p-4 rounded-lg border border-gray-300"></textarea>
              </div>
                ...
                <div className="text-center">
                  {
                    loading?<div
                    className=" inline-block px-6 py-3 bg-yellow-500 text-white font-semibold rounded-lg hover:bg-yellow-600 transition duration-300">
